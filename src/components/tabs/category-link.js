...
const Tab = ({children,path, name, current})=>{
    const style = current == name ? tab_style.focus : tab_style.default
    return(<Link href={path} className={style}>{children}</Link>)
}

export default function CategoryLink({
    page,
    current // @returns category name
}){
